...
![](C:\Users\user\AppData\Roaming\marktext\images\2025-06-24-17-57-54-image.png)
...
![](C:\Users\user\AppData\Roaming\marktext\images\2025-06-24-17-58-09-image.png)

```matlab
%NuEUAvg(1,t)=sum(NuEU(:))/params.length0.^2*0.5*Prandtl+1;
```

![](C:\Users\user\AppData\Roaming\marktext\images\2025-06-24-17-58-36-image.png)
